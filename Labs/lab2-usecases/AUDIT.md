...
**Виправив:** додав Google OAuth як зовнішнього актора, пов'язав з UC2 (Login). Коміт: `lab2: fix - add google oauth actor + generalization`
...
**Виправив:** додав UC9 (Authenticate) з include для UC2, UC3, UC5, UC6, UC7. Додав extend UC8 -> UC4 (Search extends Watch). Додав generalization Guest -.-> User. Коміт: `lab2: fix - add include extend relationships`
...
**Виправив:** переписав матрицю - REQ5 -> UC6 + 2 Gherkin scenarios, REQ8/REQ9 -> UC5, REQ10 -> не покрито (пояснення). Додав REQ11 як непокриту вимогу з поясненням. Коміт: `lab2: add ears, user stories, gherkin, traceability`
