...
- userId (FK -> User.id)
- videoId (FK -> Video.id)
- createdAt (коли лайкнуто - власний атрибут, тому асоціативна сутність а не чистий зв'язок M:N)
...
- [x] M:N зв'язки мають асоціативні сутності (Like, Subscription) - з власними атрибутами (createdAt), бо чистий M:N без атрибутів - це зв'язок а не сутність
